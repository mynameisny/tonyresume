...
class wpspace_recent_posts_widget extends WP_Widget {
	...
	function wpspace_recent_posts_widget() {
		...
		/* Create the widget. */
		$this->WP_Widget('wpspace-recent-posts-widget', 'WP Space - Recent Blog Posts', $widget_ops, $control_ops);
	}
		...
		foreach ($recent_posts as $post) {
			...
			$output .= '
                        	<li class="article">
                                ...
                                <ol class="icons">
                                	<li class="post_date"><span class="icon-time"></span>' . date('M.d', strtotime($post['post_date'])) . '</li>
